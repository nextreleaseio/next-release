    ...
    return (
        <Accordion>
            {nodes.map((faq, index) => {
                return (
                    <AccordionItem
                        className="mt-4 bg-white rounded border-1 shadow py-4 px-6"
                        key={index}
                    >
                        <AccordionItemHeading>
...
const Help = ({ data }) => {
    ...
    return (
        <Layout headerClass="bg-white relative">
            <SEO title="Help" />
            <div
                className="w-100 bg-purple-800 text-center bg-no-repeat bg-center bg-cover md:py-32 sm:py-8"
            ...
            <div className="py-6 pb-12 px-6 md:px-10 lg:px-24 flex justify-center">
                ...
                <div className="md:w-1/3 sm:w-1/2 flex flex-col p-8 rounded border border-grey-300 hover:shadow hover:bg-grey-100">
                    <img
                        alt="Using Next Release Narwhal"
                        src={computer}
                        className="max-w-full"
                    />
                    <div className="text-center">
            ...
            <div className="py-6 pb-12 px-6 md:px-10 lg:px-24 bg-grey-100">
                <div className="m-auto md:w-1/2 sm:w-full">
                    <h4 className="font-bold text-center text-grey-700 tracking-wide">
