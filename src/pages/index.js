...
import home from "../images/NextRelease_Color_Icon.svg";
...
const Logo = ({className}) => {
  className = cx(className, "bg-right-top bg-no-repeat");
  return (
    <div className={className} style={{ backgroundImage: `url(${home})` }}></div>
  );
}
    ...
    <Layout headerClass="relative bg-white">
      ...
      <div className="w-full bg-purple-800">
        <div className="px-6 md:px-10 lg:px-24 text-white py-20">
          <h1 className="font-bold text-5xl">Effortless Release Notes</h1>
          <h2 className="text-purple-200 text-3xl">Consistent notes for every release, for every project</h2>
          <a href="https://my.nextrelease.io" className="btn btn-orange text-3xl mt-8 inline-block">
            Start Free Trial
          </a>
        </div>
      </div>
      <div className="bg-grey-100 w-100 px-6 md:px-10 lg:px-24">
