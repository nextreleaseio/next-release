  ...
  return (
    <Layout>
      ...
      <Row classNames="bg-purple-800 text-center bg-no-repeat bg-center bg-cover md:py-12 sm:py-8"
        ...
        <p className="text-small text-teal-400 uppercase">Automatic Release Notes with Next Release</p>
        <h1 className="text-4xl font-bold text-white">{name} Personal Demo</h1>
